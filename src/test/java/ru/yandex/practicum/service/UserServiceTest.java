...
//        userService = new UserService(userStorage);
    ...
    public void addToStorageUserWithFailName() {
        ...
        assertEquals(
                "User(id=1, email=email@email, login=login1, name=login1, birthday=2000-01-03)"
                , userNameIsNullAfterChecking.toString()
                , "Ошибка тестирования перевода в строку юзера с 'name' = null.");
        
        //Тест юзера с пустым name:
        assertEquals(
                "User(id=2, email=email@email, login=login2, name=login2, birthday=2000-01-03)"
        ...
        assertEquals(
                "User(id=3, email=email@email, login=login3, name=login3, birthday=2000-01-03)"
    ...
    public void updateInStorageUserWithEmptyName() {
        ...
        assertEquals("User(id=0, email=email@email, login=login, name=login, birthday=2000-01-03)"
